...
export const AVAILABLE_INDICATORS = [
  // --- TREND ---
  {
    ...
    description: "Reacts more significantly to recent price changes.",
    defParams: { period: 20 },
    presets: [8, 9, 10, 20, 21, 34, 50, 100, 200],
    color: "#FF6D00",
  },
  {
    id: "SMA",
    ...
    category: INDICATOR_CATEGORIES.TREND,
    description: "The average of prices over a specific period.",
    defParams: { period: 20 },
  ...
  },
  {
    ...
    category: INDICATOR_CATEGORIES.TREND,
    description: "Assigns more weight to recent data points.",
    defParams: { period: 20 },
    color: "#00E676",
  },
  {
    ...
    defParams: { fastPeriod: 12, slowPeriod: 26, signalPeriod: 9 },
    color: "#2962FF",
  },
  {
    id: "SuperTrend",
    name: "SuperTrend",
    category: INDICATOR_CATEGORIES.TREND,
    description: "Trend-following indicator like moving averages.",
    defParams: { period: 10, multiplier: 3 },
    color: "#D500F9",
  },
  {
    id: "Ichimoku",
    name: "Ichimoku Cloud",
    category: INDICATOR_CATEGORIES.TREND,
    description: "Collection of indicators showing support/resistance.",
    defParams: {
      conversionPeriod: 9,
      basePeriod: 26,
      spanPeriod: 52,
  ...
  },
  {
    ...
    name: "Parabolic SAR",
    category: INDICATOR_CATEGORIES.TREND,
    description: "Highlights potential reversals.",
    defParams: { step: 0.02, max: 0.2 },
    color: "#00B0FF",
  },
  {
    id: "ADX",
  ...
  },
  {
    ...
    category: INDICATOR_CATEGORIES.TREND,
    description: "Identifies in which direction the price is moving.",
    defParams: { period: 14 },
    color: "#2979FF",
  },
  {
    ...
    category: INDICATOR_CATEGORIES.TREND,
    description: "Reduces lag while improving smoothing.",
    defParams: { period: 9 },
    color: "#F50057",
  },
  {
  ...
  },
  {
    ...
    category: INDICATOR_CATEGORIES.TREND,
    description: "Adjusts to market noise.",
    defParams: { period: 10, fastPeriod: 2, slowPeriod: 30 },
    color: "#651FFF",
  },
  {
    id: "GMMA",
    name: "Guppy Multiple MA",
    category: INDICATOR_CATEGORIES.TREND,
    description: "Identifies changing trends.",
    defParams: {
  ...
  },
  {
    ...
    name: "Heiken Ashi",
    category: INDICATOR_CATEGORIES.TREND,
    description: "Modified candles for trend visualization.",
    defParams: {},
    color: "#2962FF",
  },
  ...
  // --- OSCILLATORS ---
  {
    ...
    category: INDICATOR_CATEGORIES.OSCILLATOR,
  ...
  },
  {
    ...
    defParams: { period: 14, signalPeriod: 3 },
    presets: ["5-3-3", "14-3-3", "21-9-9"],
    color: "#2979FF",
  },
  {
    id: "StochRSI",
    ...
    defParams: { rsiPeriod: 14, stochasticPeriod: 14, kPeriod: 3, dPeriod: 3 },
    color: "#D500F9",
  },
  {
    id: "CCI",
    ...
    category: INDICATOR_CATEGORIES.OSCILLATOR,
    description: "Identifies cyclical turns.",
    defParams: { period: 20 },
    color: "#00E676",
  },
  {
  ...
  },
  {
    ...
    category: INDICATOR_CATEGORIES.OSCILLATOR,
    description: "Combines short, medium, and long-term periods.",
    defParams: { period1: 7, period2: 14, period3: 28 },
    color: "#FF6D00",
  },

  {
    ...
    name: "DeMarker",
    category: INDICATOR_CATEGORIES.OSCILLATOR,
    description: "Identifies potential price exhaustion.",
    defParams: { period: 14 },
    color: "#2962FF",
  },
  {
    ...
    defParams: { fastPeriod: 5, slowPeriod: 34 },
    color: "#FF6D00",
  },

  {
    ...
    name: "TRIX",
    category: INDICATOR_CATEGORIES.OSCILLATOR,
    description: "Triple-smoothed EMA oscillator.",
    defParams: { period: 18 },
    color: "#D500F9",
  },
  ...
  },
  {
    ...
    category: INDICATOR_CATEGORIES.VOLATILITY,
    description: "Highest high and lowest low.",
    defParams: { period: 20 },
    color: "#F50057",
  },
  {
    ...
    defParams: { period: 20, multiplier: 1 },
    color: "#651FFF",
  },
  {
    id: "ChaikinVol",
    ...
    category: INDICATOR_CATEGORIES.VOLATILITY,
    description: "Change in spread between high and low.",
    defParams: { period: 10, rocPeriod: 10 },
    color: "#FFAB00",
  },
  {
    id: "HV",
...
const IndicatorMenu = ({
  ...
  const toggleSelection = (indicator, paramOverride = null) => {
    setTempSelected((prev) => {
      const effectiveParams = paramOverride
        ? { ...indicator.defParams, ...paramOverride }
        : indicator.defParams;
  ...
  const getSelectedValue = (indicator) => {
    ...
    if (indicator.id === "STOCH") {
      ...
      const match = indicator.presets.find((pre) =>
        pre.startsWith(`${p}-${k}`),
      );
      return match || "";
    }
  ...
  const categories = [
    ...
    {
      id: INDICATOR_CATEGORIES.OSCILLATOR,
      label: "Oscillators",
      icon: Activity,
    },
  ...
  const content = (
    <div
      className="fixed inset-0 flex items-center justify-center bg-transparent p-4 animate-in fade-in duration-200"
    ...
    >
      ...
      >
        <div className="flex flex-1 overflow-hidden">
          ...
          <div
            className="w-56 bg-gray-50 border-r border-gray-100 flex flex-col py-4"
                ...
                {filteredIndicators.map((ind) => {
                  ...
                  return (
                    <div
                      ...
                      className={`group flex items-center justify-between p-3 mx-1 rounded-lg cursor-pointer transition-all duration-200 border border-transparent ${
                        active && !ind.presets
                    ...
                    >
                      <div className="flex items-center gap-3 flex-1">
                        ...
                        <div
                          className={`w-8 h-8 rounded-md flex items-center justify-center text-[10px] font-bold transition-colors ${
                            active
                      ...
                      <div className="flex items-center gap-0.5">
                        <button
                          onClick={(e) => {
                            ...
                            onToggleFavorite({
                              ...
                              payload: {
                                id: ind.id,
                                params: ind.defParams,
                                color: ind.color,
                              },
                              label: ind.name,
                              subtitle: ind.id.substring(0, 2),
                              icon: (() => {
                                switch (ind.category) {
                                  case INDICATOR_CATEGORIES.TREND:
                                    return TrendingUp;
                                  case INDICATOR_CATEGORIES.OSCILLATOR:
                                    return Activity;
                                  case INDICATOR_CATEGORIES.VOLATILITY:
                                    return Zap;
                                  case INDICATOR_CATEGORIES.VOLUME:
                                    return BarChart2;
                                  default:
                                    return Activity;
                                }
                          ...
                          className={`p-1.5 rounded-full hover:bg-yellow-50 transition-colors ${
                            favorites.some((f) => f.payload?.id === ind.id)
                              ? "text-yellow-500"
                        ...
                        >
                          <Star
                            className={`w-4 h-4 ${favorites.some((f) => f.payload?.id === ind.id) ? "fill-current" : ""}`}
                          />
                        </button>
                      </div>
                    </div>
        ...
        {/* Footer: Apply Button */}
        <div
          className="p-4 border-t border-gray-100 bg-gray-50 flex justify-end gap-3"
          style={{ backgroundColor: "#f9fafb" }}
        >
          <button
            onClick={onClose}
