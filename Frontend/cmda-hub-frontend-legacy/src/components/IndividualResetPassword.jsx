...
import { KeyRound, ShieldCheck, TrendingUp, ArrowLeft, CheckCircle2 } from "lucide-react";
...
const IndividualResetPassword = () => {
  ...
  return (
    <div className="font-sans text-gray-900 dark:text-gray-100 min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col relative overflow-hidden pt-20 md:pt-24">
      <Helmet>
        <title>Reset Password – CMDA Hub</title>
        <meta name="description" content="Securely reset your CMDA Hub account password." />
      </Helmet>
        ...
        >
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20 dark:border-gray-700/50">
            ...
            {error && (
              ...
              >
                <div className="mr-3 bg-red-100 dark:bg-red-900/40 p-1 rounded-full">
              ...
              <div className="space-y-3">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="block w-full pl-12 pr-12 py-4 bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-2xl leading-5 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all duration-300"
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="text-center group">
                <div className="inline-flex items-center justify-center w-24 h-24 bg-emerald-100 dark:bg-emerald-900/30 rounded-full mb-6 group-hover:scale-110 transition-transform duration-500">
                  <CheckCircle2 className="text-emerald-500 dark:text-emerald-400" size={56} />
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-blue-600 dark:text-blue-400 text-sm font-semibold italic">
                    Tip: Use a unique password for better security.
                  </p>
                </div>
              </div>
            </motion.div>
