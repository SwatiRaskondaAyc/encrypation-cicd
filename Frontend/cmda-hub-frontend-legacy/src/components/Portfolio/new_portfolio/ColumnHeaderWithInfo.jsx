...
const ColumnHeaderWithInfo = ({ label, description, right = false }) => {
  ...
  return (
    <>
      <div
        ref={headerRef}
        className={`flex items-center gap-1 group relative cursor-help ${right ? "justify-end" : ""
          }`}
      ...
      >
        ...
        <HelpCircle
          size={13}
          className="text-gray-400 dark:text-gray-500 group-hover:text-blue-500 transition-colors flex-shrink-0"
        />
      </div>
