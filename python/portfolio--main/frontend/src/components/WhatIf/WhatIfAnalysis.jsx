...
const MetricCard = ({
  ...
  return (
    <div className="group relative bg-white rounded-xl p-3 border border-slate-100 shadow-sm hover:shadow-md transition-all">
    ...
    <div className="space-y-4 animate-in slide-in-from-right-4 duration-500">
          ...
          <div className="flex items-start justify-between gap-6">
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                {conclusion?.verdict === "POSITIVE" ? (
                  <span className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-emerald-100 text-emerald-700 text-[10px] font-bold tracking-wider uppercase border border-emerald-200">
                    <ShieldCheck className="w-3.5 h-3.5" /> Thumbs Up
                  </span>
                ) : conclusion?.verdict === "NEGATIVE" ? (
                  <span className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-rose-100 text-rose-700 text-[10px] font-bold tracking-wider uppercase border border-rose-200">
                    <AlertTriangle className="w-3.5 h-3.5" /> Caution
                  </span>
                ) : (
                  <span className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-slate-100 text-slate-700 text-[10px] font-bold tracking-wider uppercase border border-slate-200">
        ...
        <div className="bg-white rounded-2xl p-4 border border-slate-200 shadow-sm flex flex-col justify-center">
          ...
          <div className="flex items-center justify-around relative">
            ...
            <div className="w-[140px] h-[160px] relative flex flex-col items-center">
              ...
              <span className="text-[9px] font-bold text-indigo-500 mt-1 uppercase">
                NOW
              </span>
            </div>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-x-4 gap-y-2 mt-2 px-2">
            {currentSectorData.slice(0, 5).map((entry, index) => (
              ...
              >
                ...
                />
                <span
                  className="text-[9px] text-slate-500 font-medium truncate max-w-[80px]"
                  title={entry.name}
                >
                  {entry.name}
                </span>
      ...
      <div className="border-t border-slate-100 pt-4">
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-3 bg-slate-50 hover:bg-slate-100 text-slate-500 rounded-xl transition-all text-xs font-bold uppercase tracking-wide border border-slate-200 border-dashed"
        >
          {showDeepDive
