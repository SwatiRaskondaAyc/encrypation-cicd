...
const SimulationBuilder = ({
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl shadow-indigo-500/20 border border-slate-100 overflow-hidden w-full max-w-md animate-in zoom-in-95 duration-200">
      {/* Ticket Header */}
      <div className="bg-slate-800 p-4 text-white flex justify-between items-center">
        ...
        <button
          onClick={onCancel}
          className="hover:bg-white/20 p-1 rounded-full text-slate-400 hover:text-white transition-colors"
        >
          <X className="w-4 h-4" />
        </button>
      </div>
      ...
      <div className="p-5 space-y-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-center w-1/3">
            <div className="bg-rose-50 border border-rose-100 rounded-xl p-2 mb-1">
          ...
          {/* TARGET */}
          <div className="text-center w-1/3">
            <div className="bg-emerald-50 border border-emerald-100 rounded-xl p-2 mb-1">
              <div className="font-bold text-emerald-700">
                {targetStock.symbol}
              </div>
            </div>
            <div className="text-[10px] text-slate-500 font-medium">BUYING</div>
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 bg-white border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
        ...
        {tradeType === "PARTIAL" && (
          <div className="bg-slate-50 rounded-xl p-3 border border-slate-200">
            ...
            <input
              ...
              className="w-full bg-white border border-slate-200 rounded-lg px-3 py-2 text-sm font-mono focus:ring-2 focus:ring-indigo-500/20 outline-none"
              placeholder="0"
            />
        ...
        <div className="border-t border-slate-100 pt-3">
          <div className="flex justify-between items-center text-xs mb-1">
            <span className="text-slate-500">Value Sold:</span>
            <span className="font-mono">
              {formatCurrency(estimatedSellValue)}
            </span>
          </div>
          <div className="flex justify-between items-center text-xs mb-2">
            <span className="text-slate-500">Value Bought:</span>
          ...
          <button
            ...
            className="w-full py-3 bg-indigo-600 hover:bg-indigo-700 disabled:bg-slate-300 disabled:cursor-not-allowed text-white rounded-xl font-bold shadow-lg shadow-indigo-500/30 flex items-center justify-center gap-2 transition-all active:scale-[0.98]"
          >
            <RefreshCw
              className={`w-4 h-4 ${
                tradeType !== "ADD_FUNDS" ? "rotate-90" : ""
              }`}
            />
